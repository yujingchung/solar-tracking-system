#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""sandbox quick test v8 (10% sample, 25 epochs)"""
...
spec = importlib.util.spec_from_file_location(
    "solar_anfis_model_v8",
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "solar_anfis_model_v8.py")
)
...
OUTPUT_DIR = "/sessions/peaceful-upbeat-keller/mnt/solar-tracking-dashboard/algorithms/runs/run11_v8_quicktest"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=" * 60)
print("v8 sandbox quick test (10% sample, 25 epochs)")
print("=" * 60)
