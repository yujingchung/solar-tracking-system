# 實驗組 I｜ANFIS 智慧追日 — system_id=1

樹莓派部署資料夾，**整個複製到 Pi 的 /home/pi/solar_tracking/實驗組1/**。
...
```
scp -r .\raspberry-pi\deploy\solar_tracking\實驗組1 pi@<Pi-IP>:/home/pi/solar_tracking/
```
...
### 看最近 log
```bash
tail -100 /home/pi/solar_tracking/實驗組1/service.log
```
