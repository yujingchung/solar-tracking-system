# 對照組 II｜差分感測追日 — system_id=4

樹莓派部署資料夾，**整個複製到 Pi 的 /home/pi/solar_tracking/對照組2/**。
...
```
scp -r .\raspberry-pi\deploy\solar_tracking\對照組2 pi@<Pi-IP>:/home/pi/solar_tracking/
```
...
```bash
ssh pi@<Pi-IP>
cd /home/pi/solar_tracking/對照組2
ls -la
```
...
tail -f /home/pi/solar_tracking/對照組2/service.log
```
...
### 看最近 log
```bash
tail -100 /home/pi/solar_tracking/對照組2/service.log
```
